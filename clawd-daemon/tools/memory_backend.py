...
class MemoryBackend:
    ...
    # === Knowledge Graph ===
    # REMOVED (post-op D2, 2026-07-01): save_entity/save_edge/load_graph had
    # zero callers and routed to the retired SQLite kg_* mirror. The single KG
    # store is knowledge_graph.json — use tools.knowledge_graph (add_entity_raw,
    # add_edge_raw, _load_graph) directly.
